...
public class Main_ffmpeg {
    static void save_frame(avutil.AVFrame pFrame, int width, int height, int f_idx) throws IOException {
        // Open file
    ...
    public static void main(String[] args) throws Exception {
        ...
        String vf_path = "D:\\git-repos\\S3-CB03-Group3\\PAAS\\src\\main\\java\\com\\video\\recognition\\eu-clip.mp4";
        ...
        while (av_read_frame(fmt_ctx, pkt) >= 0) {
            ...
            // if (fi && ++i <= 5) {
            if (ret2 >= 0 && ++i <= 100) {
                //System.out.println("azise");

                //System.out.println(LicenseReader.licenseReader("../../../../../" + "frame" + Integer.toString(j+1) + "_.ppm"));
                av_image_fill_arrays(pFrameRGB.data(), pFrameRGB.linesize(),
        ...
        System.out.println(LicenseReader.licenseReader("frame56_.ppm"));
